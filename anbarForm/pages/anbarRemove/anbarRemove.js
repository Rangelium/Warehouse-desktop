								...
								<div class="sessionTable">
											...
											<div class="sessionTableContent">
												<div class="sessionTableRow">
													...
													<div class="sessionTableData" title="${moment(i.begin_date).format(
														"Da MMMM YYYY, h:mm:ss"
													)}">${moment(i.begin_date).format(
							"DD MMMM YYYY"
						)}</div>
				...
				sessionCards.forEach((el) => {
					el.addEventListener("click", () => {
						sessionCards.forEach((sel) => {
							...
							sel
								.querySelector(".sessionTableHeader")
								.classList.remove("sessionSelected");
							sel
								.querySelector(".sessionTableRow")
								.classList.remove("sessionSelected");
						});
						// el.classList.toggle("sessionSelected");
						el.classList.toggle("sessionSelected");
						el.querySelector(".sessionTable").classList.toggle(
							"sessionSelected"
						);
						el.querySelector(".sessionTableHeader").classList.toggle(
							"sessionSelected"
						);
						el.querySelector(".sessionTableRow").classList.toggle(
							"sessionSelected"
						);
									...
									<div class="sessionInfoTable">
											...
											<div class="sessionInfoTableContent">
												<div class="sessionInfoTableRow">
													...
													<div class="sessionInfoTableData" title="${moment(i.exp_date).format(
														"DD MMMM YYYY, h:mm:ss"
													)}">${moment(i.exp_date).format("DD/MM/YYYY")}</div>
